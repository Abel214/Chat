...
from chat import abrir_editor_codigo
...
def crear_interfaz():
    ...
    def acerca_de():
        messagebox.showinfo("Acerca de", "Desarrollado por:  Abel Mora")

    # Crear el menú
    menu = tk.Menu(ventana)
    ventana_principal = tk.Menu(menu, tearoff=0)
    ventana_principal.add_command(label="Programa", command=abrir_editor_codigo)
